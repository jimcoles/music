 ...
 * @author  Andrew Brown
 * @author  Adam Kirby
 * @version $Revision: 1.3 $, $Date: 2003/05/05 15:27:35 $
 */
public class Mod implements JMC{
	...
	* @param transposition the amount to transpose in semitones
	...
	public static void transpose(Phrase phrase, final int transposition) { 
		...
		Enumeration enumElem = noteList.elements();
		while (enumElem.hasMoreElements()){
			Note note = (Note) enumElem.nextElement();
    ...
    public static void repeat(Phrase phrase, int times, double startLoc, 
        ...
        * increases the dynamic by a certain amount - <br>
        ...
        public static void increaseDynamic(Phrase phr, int amount) {
                ...
                Enumeration enumElem = phr.getNoteList().elements();
                while(enumElem.hasMoreElements()) {
                        Note n = (Note)enumElem.nextElement();
	...
	*/
	public static void fadeIn(Phrase phrase, final double fadeLength) {
		...
		Enumeration enumElem = phrase.getNoteList().elements();
		while (enumElem.hasMoreElements()) {
			if (rhythmValueCounter > fadeLength) {
				break;
			}
			Note nextNote = (Note) enumElem.nextElement();
   ...
   /**
    ...
    public static void compress(Phrase phrase, final double ratio) {
		...
		// compress the sucker
        enumElem = phrase.getNoteList().elements();
		while(enumElem.hasMoreElements()){
			Note note = (Note) enumElem.nextElement();
    ...
    public static void append(Phrase phrase1, Phrase phrase2){
        ...
        Enumeration enumElem = phrase2.getNoteList().elements();
		while(enumElem.hasMoreElements()){
            phrase1.addNote(((Note) enumElem.nextElement()).copy());
		}
	}
    ...
    public static void cycle(Phrase phrase, final int numNotes) {
        ...
        Enumeration enumElem = newPhr.getNoteList().elements();
        while(enumElem.hasMoreElements()){
            phrase.getNoteList().addElement(enumElem.nextElement());
	    }
	}
    ...
    public static void retrograde(Phrase phrase) {
		...
		// update the phrase
        phrase.getNoteList().removeAllElements();
        Enumeration enumElem = backwards.getNoteList().elements();
		while(enumElem.hasMoreElements()){
            phrase.getNoteList().addElement(enumElem.nextElement());
	    }
	}
   ...
   /**
    ...
    public static void normalise(Phrase phrase){
		...
		Enumeration enumElem2 = phrase.getNoteList().elements();
		while(enumElem2.hasMoreElements()){
            Note n = (Note) enumElem2.nextElement();
	...
	*/
	public static void transpose(CPhrase cphrase, final int trans){
		...
		Enumeration enumElem = cphrase.getPhraseList().elements();
		while(enumElem.hasMoreElements()){
			transpose((Phrase) enumElem.nextElement(), trans);
		}
	}
	...
	*/
	...
	Enumeration enumElem = cphrase.getPhraseList().elements();
	while(enumElem.hasMoreElements()){
	transpose((Phrase) enumElem.nextElement(), transposition, mode, key);
	}
	}
	...
	*/
    ...
    public static void repeat(CPhrase cphrase, final int times,
        ...
        Enumeration enumElem = cphrase.getPhraseList().elements();
		while(enumElem.hasMoreElements()){
			Phrase nextPhrase = (Phrase)enumElem.nextElement();
    ...
    public static void compress(CPhrase cphrase, final double ratio) {
        ...
        Enumeration enumElem = cphrase.getPhraseList().elements();
		while(enumElem.hasMoreElements()){
            compress((Phrase) enumElem.nextElement(), ratio);
		}
	}
    ...
    public static void append(CPhrase cphrase1, final CPhrase cphrase2) {
		...
		Enumeration enumElem = cphrase2.getPhraseList().elements();
		while(enumElem.hasMoreElements()){
		    Phrase tempPhrase = (Phrase) enumElem.nextElement();
    ...
    public static void merge(CPhrase cphrase1, final CPhrase cphrase2) {
		...
		Enumeration enumElem = cphrase2.getPhraseList().elements();
		while(enumElem.hasMoreElements()){
            cphrase1.addPhrase((Phrase) enumElem.nextElement());
		}
	}
    ...
    public static void quantise(CPhrase cphrase, final double qValue) {
        ...
        Enumeration enumElem = cphrase.getPhraseList().elements();
        while(enumElem.hasMoreElements()) {
            quantise((Phrase) enumElem.nextElement(), qValue);
		}
	}
    ...
    public static void elongate(CPhrase cphrase, final double scaleFactor) {
        ...
        Enumeration enumElem = cphrase.getPhraseList().elements();
		while(enumElem.hasMoreElements()){
			Phrase phr = ((Phrase) enumElem.nextElement());
    ...
    public static void accents(CPhrase cphrase, final double meter,
        ...
        Enumeration enumElem = cphrase.getPhraseList().elements();
        while(enumElem.hasMoreElements()) {
		    Phrase phrase = (Phrase) enumElem.nextElement();
    ...
    public static void normalise(CPhrase cphrase){
        ...
        while(enumElem.hasMoreElements()) {
            Phrase phrase = (Phrase) enumElem.nextElement();
            Enumeration enumElem1 = phrase.getNoteList().elements();
    		while(enumElem1.hasMoreElements()){
                Note n = (Note) enumElem1.nextElement();
                if (n.getDynamic() > max) max = n.getDynamic();
    		}
    	}
		// increase the normalisation
		...
		int diff = Note.MAX_DYNAMIC - max;
		Enumeration enumElem3 = cphrase.getPhraseList().elements();
        while(enumElem3.hasMoreElements()) {
            Phrase phrase = (Phrase) enumElem3.nextElement();
    		Enumeration enumElem2 = phrase.getNoteList().elements();
    		while(enumElem2.hasMoreElements()){
                Note n = (Note) enumElem2.nextElement();
                n.setDynamic(n.getDynamic() + diff);
    ...
    * Adjusts all Notes' duration values to vary randomly between specified values from note to note.
    ...
    public static void repeat(Part part, final int times){
        ...
        Enumeration enumElem = part.getPhraseList().elements();
        while(enumElem.hasMoreElements()){
            Phrase nextPhrase = (Phrase)enumElem.nextElement();
    ...
    public static void transpose(Part part, final int degrees, final int[] mode, int key) { 
        ...
        Enumeration enumElem = part.getPhraseList().elements();
		while(enumElem.hasMoreElements()){
            transpose((Phrase) enumElem.nextElement(), degrees, mode, key);
		}
	}
    ...
    public static void append(Part part1, final Part part2,
        ...
        //go through the phrases in the new part
        // and add then one by one
            Enumeration enumElem = part2.getPhraseList().elements();
            while(enumElem.hasMoreElements()){
                Phrase tempPhrase = ((Phrase) enumElem.nextElement()).copy();
        ...
        * Increases the dynamic by a certain amount - <br>
        ...
        public static void increaseDynamic(Part p, int amount) {
                ...
                Enumeration enumElem = p.getPhraseList().elements();
                while(enumElem.hasMoreElements()) {
                        Phrase phr = (Phrase)enumElem.nextElement();
    ...
    public static void merge(Part part1, final Part part2) {
		...
		Enumeration enumElem = part2.getPhraseList().elements();
		while(enumElem.hasMoreElements()){
            part1.addPhrase((Phrase) enumElem.nextElement());
		}
	}
    ...
    public static void normalise(Part part){
		...
		int diff = Note.MAX_DYNAMIC - max;
		Enumeration enumElem3 = part.getPhraseList().elements();
        while(enumElem3.hasMoreElements()) {
            Phrase phrase = (Phrase) enumElem3.nextElement();
    		Enumeration enumElem2 = phrase.getNoteList().elements();
    		while(enumElem2.hasMoreElements()){
    ...
    * Adjusts all Notes' duration values to vary randomly between specified values from note to note.
	 ...
	 */
	 public static void transpose(Score scr, final int transposition){
		 ...
		 Enumeration enumElem = scr.getPartList().elements();
		 while(enumElem.hasMoreElements()){
    ...
    public static void transpose(Score score, final int degrees, final int[] mode, int key) { 
		...
		while(enumElem.hasMoreElements()){
            transpose((Part) enumElem.nextElement(), degrees, mode, key);
		}
	} 
    ...
    public static void fadeIn(Score score, final double fadeLength){
        ...
        Enumeration enumElem = score.getPartList().elements();
		while(enumElem.hasMoreElements()){
			Part nextPart = (Part)enumElem.nextElement();
        ...
        * increases the dynamic by a certain amount - <br>
        ...
        public static void increaseDynamic(Score s, int amount) {
                ...
                Enumeration enumElem = s.getPartList().elements();
                while(enumElem.hasMoreElements()) {
                        Part p = (Part)enumElem.nextElement();
    ...
    public static void append(Score score1, final Score score2) {
        ...
        Enumeration enumElem = score2.getPartList().elements();
        while(enumElem.hasMoreElements()) {
            Part currPart = (Part) enumElem.nextElement();
            // update start times and program changes
            Enumeration enumElem2 = currPart.getPhraseList().elements();
            while(enumElem2.hasMoreElements()) {
                Phrase currPhrase = (Phrase)enumElem2.nextElement();
    ...
    */
    ...
    public static void normalise(Score score){
        ...
        // get the curent max
        int max = 0;
        Enumeration enumElemS = score.getPartList().elements();
		while(enumElemS.hasMoreElements()){
		Part part = (Part) enumElemS.nextElement();
            Enumeration enumElem = part.getPhraseList().elements();
            while(enumElem.hasMoreElements()) {
                Phrase phrase = (Phrase) enumElem.nextElement();
                Enumeration enumElem1 = phrase.getNoteList().elements();
		...
		int diff = Note.MAX_DYNAMIC - max;
		Enumeration enumElemS2 = score.getPartList().elements();
		while(enumElemS2.hasMoreElements()){
			Part part = (Part) enumElemS2.nextElement();
    		Enumeration enumElem3 = part.getPhraseList().elements();
            while(enumElem3.hasMoreElements()) {
                Phrase phrase = (Phrase) enumElem3.nextElement();
        		Enumeration enumElem2 = phrase.getNoteList().elements();
