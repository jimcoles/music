...
//		this.startTime = startTime;
	...
	public void addNoteList(Vector noteVector, boolean append){
		Enumeration enumElem = noteVector.elements();
...
//            this.startTime = startTime;
	...
	public double getEndTime(){	
		...
		Enumeration enumElem = this.noteList.elements();
		while(enumElem.hasMoreElements()){
	...
	*/
	public Phrase copy(){
		...
		Enumeration enumElem = this.noteList.elements();
		while(enumElem.hasMoreElements()){
			phr.addNote( ((Note) enumElem.nextElement()).copy() );
		}
		return phr;
	}
...
//		phr.setStartTime(this.startTime);
		...
		Enumeration enumElem = this.noteList.elements();
		while(enumElem.hasMoreElements()){
                    Note n = ((Note)enumElem.nextElement()).copy();
	...
	public String toString(){
		...
		Enumeration enumElem = getNoteList().elements();
		int counter = 0; 
		while(enumElem.hasMoreElements()){
			Note note = (Note) enumElem.nextElement();
