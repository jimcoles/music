...
public class CPhrase implements JMC, Cloneable, Serializable{
	...
	*/
	public void setStartTime(double startTime){
		...
		Enumeration enumElem = this.phraseList.elements();
		while(enumElem.hasMoreElements()){
			Phrase ph;
			ph = (Phrase) enumElem.nextElement();
	...
	*/
	public double getEndTime(){	
		...
		Enumeration enumElem = this.phraseList.elements();
		while(enumElem.hasMoreElements()){
			Phrase nextPhr = (Phrase)enumElem.nextElement();
	...
	public void setPan(double pan){
		this.pan = pan;
		Enumeration enumElem = phraseList.elements();
		while(enumElem.hasMoreElements()){
    ...
    public int getHighestPitch() {
        int max = 0;
        Enumeration enumElem = getPhraseList().elements();
		while(enumElem.hasMoreElements()){
			Phrase phrase = (Phrase) enumElem.nextElement();
	...
	*/
	public CPhrase copy(){
		...
		Enumeration enumElem = this.phraseList.elements();
		while(enumElem.hasMoreElements()){
			Phrase ph = ((Phrase) enumElem.nextElement()).copy();
	...
	*/
	public CPhrase copy(double startLoc, double endLoc){
		...
		Enumeration enumElem = this.phraseList.elements();
		while(enumElem.hasMoreElements()){
			Phrase ph = ((Phrase) enumElem.nextElement()).copy(startLoc, endLoc);
			ph.setStartTime(0.0);
			tempVect.addElement(ph);			
		}
		cp.setPhraseList(tempVect);
        ...
        */
        public void flam(final double offsetAmount){
            ...
            while(enumElem.hasMoreElements()){
                ...
                Enumeration enumElem2 = phr.getNoteList().elements();
