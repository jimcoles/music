...
<This Java Class is part of the jMusic API version 1.4, February 2003.>:43  2001
...
public class Track{
	...
	public void print(){
		...
		Enumeration enumElem = eventList.elements();
		while(enumElem.hasMoreElements()){
			Event event = (Event) enumElem.nextElement();
			//event.print();
		}
		//System.out.println();
	}
