...
public class MidiSynth implements JMC, MetaEventListener {
    ...
    */
    ...
    protected void printSeqInfo(Sequence seq) {
        ...
        //System.out.println("Score Tempo: " + m_currentTempo + " BPM");
        ...
        System.out.println("Sequencer Tempo (BPM) = " +
                           m_sequencer.getTempoInBPM());
        System.out.println("Sequencer Tempo (MPQ) = " +
    ...
    protected Sequence scoreToSeq(Score score)
        ...
        while(parts.hasMoreElements()) {
            ...
            if (tempo != Part.DEFAULT_TEMPO) {
                ...
                System.out.println("jMusic MidiSynth error: Part Tempo (BPM) = " + tempo);
		...
		// ////////////////////////////
                ...
                if (tempo != Phrase.DEFAULT_TEMPO) {
                    m_currentTempo = tempo;
                    System.out.println("jMusic MidiSynth error: Phrase Tempo (BPM) = " + tempo);
                }
