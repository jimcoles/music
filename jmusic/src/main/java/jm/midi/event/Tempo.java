...
<This Java Class is part of the jMusic API version 1.4, February 2003.>:56  2001
...
/** 
* Tempo Events are contained in the MidiFile class's tempoList 
* unlike most of the other events which are track data stored in
* the track Event List. 
* @author Andrew Sorensen
*/

public final class Tempo implements Event{
	private short id = 0;
	private int time = 0;
	...
	public Tempo(int time){
		this(time,0.0);
	}
	public Tempo(double tempo){
		this(0,tempo);
	}
	public Tempo(int time, double tempo){
		this.id = 020;
		this.time = time;
		this.tempo = tempo;
	}
	...
	public int write(DataOutputStream dos) throws IOException{ 
		...
		dos.writeByte((byte)0x51); //Tempo Event Type
	...
	/** Print data */
	public void print(){
		System.out.println("Tempo(020):             [time = " + this.time + "][tempo = " + this.tempo + "]");
	}
}
