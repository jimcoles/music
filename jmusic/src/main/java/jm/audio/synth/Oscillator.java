...
public class Oscillator extends AudioObject{
	...
	*/
	public Oscillator(AudioObject ao, int waveType, int choice, float val){
		super(ao, "[Oscillator]");
        this.waveType = waveType;
		this.choice = choice;
		if(choice == 1){
	...
	*/
	public Oscillator(Instrument inst, int waveType, int sampleRate, int channels, int fixedModChoice, float freqVal){
		super(inst, sampleRate, "[Oscillator]");
		this.waveType = waveType;
		this.channels = channels;
