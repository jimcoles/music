/*
<This Java Class is part of the jMusic API version 1.4, February 2003.> Copyright (C) 2000 Andrew Sorensen & Andrew Brown This program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by
...
public final class ReSample extends AudioObject{
	 ...
	 */
	public void build(){
		if(noteFreq)this.newFreq = FRQ[this.currentNote.getPitch()];
		this.finished = true;
	}
