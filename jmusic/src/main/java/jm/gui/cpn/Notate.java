...
public class Notate extends Frame implements 
    ...
    public void init() {
        ...
        edit.add(open);
        //------
        openJmXml = new MenuItem("Open jMusic XML file...", new MenuShortcut(106));
        ...
        edit.add(saveMidi);
        //------
        saveJmXml = new MenuItem("Save as a jMusic XML file...", new MenuShortcut(115));
    ...
    public void actionPerformed(ActionEvent e){
        ...
        */
        	...
        	Play.stopMidi(); // stop a single playback
                Play.stopCycle(); // stop a cycle playback
        }         
