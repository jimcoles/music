...
<This Java Class is part of the jMusic API version 1.4, February 2003.>:39  2001
...
public class ShowScore extends Frame implements WindowListener, ActionListener {
	...
	public ShowScore(Score score, int xPos, int yPos) {
		...
		play = new MenuItem("Play MIDI", new MenuShortcut(112));
		play.addActionListener(this);
		fileMenu.add(play);
		
		openMIDI = new MenuItem("Open a MIDI file...");
	...
	* Dialog to save phrase a s MIDI file.
	...
	public void saveMidi() {
		FileDialog fd = new FileDialog(this, "Save as a MIDI file...", 
                    FileDialog.SAVE);
		fd.show();
