...
public class SketchScore extends Frame implements WindowListener, ActionListener {
	...
	public SketchScore(Score score, int xPos, int yPos) {
		...
		Menu fileMenu  = new Menu("Sketch", true);
                ...
                play = new MenuItem("Play @ "+score.getTempo()+" bpm", new MenuShortcut(112));
		...
		fileMenu.add(clear);
                ...
                openMIDI = new MenuItem("Open a MIDI file...", new MenuShortcut(112));
		...
		saveMIDI = new MenuItem("Save as MIDI file", new MenuShortcut(115));
	...
	private void getWidthAndParts() {
            ...
            while(enumElem.hasMoreElements()){
                ...
                while(enumElem2.hasMoreElements()){
                    Phrase phrase = (Phrase) enumElem2.nextElement();
                    Enumeration enumElem3 = phrase.getNoteList().elements();
                    maxWidth = (int) (phrase.getStartTime() * beatWidth);
                    while(enumElem3.hasMoreElements()){
                        Note aNote = (Note) enumElem3.nextElement();
