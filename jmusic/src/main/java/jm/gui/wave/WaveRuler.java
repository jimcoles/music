    ...
    */
    ...
    public void paint(Graphics g) {
                    ...
                    for(int m=0; m < 10; m++) {
                        for(int i=0; i < 10; i++) {  
                            if(counter%10 != 0) {
                                ...
                                if (markerWidth>40000) g.drawString(""+ (prevSecond + counter/1000.0), 
                ...
                for(int k=0; k < 10; k++) {
                    for(int i=0; i < 10; i++) { 
                        ...
                        int pos = j+k*tenthInc+i*centInc;
                            ...
                            if (markerWidth>4800) g.drawString(""+ (prevSecond + counter/100.0), 
                                pos + 2, getSize().height - 1);
                        }
                    counter++;
                    }
            ...
            for(int j=startLoc/res; j < max; j += secInc) {
                for(int i=0; i < 10; i++) { 
                    if(counter%10 != 0) {
                        ...
                        if (markerWidth>300) g.drawString(""+ (prevSecond + counter/10.0), pos + 2,  
                            getSize().height - 1);
                    }
                    counter++;
                }
        ...
        for(int i=startLoc/res; i < max; i += secInc) { 
            ...
            if (markerWidth>20 && markerWidth <= 300) g.drawString(""+ (prevSecond + counter), i+ 2,  
                getSize().height - 1); // single digit
            else if (markerWidth>300) g.drawString(""+(prevSecond + counter/ 1.0), i+ 2,  
